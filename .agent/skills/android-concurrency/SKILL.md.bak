...
description: Coroutine usage guardrails for Kotlin backend reviewers. Use when reviewing code that mixes blocking and suspending calls, uses runBlocking, async/await patterns, or AsyncResponse with Dropwizard.
---
