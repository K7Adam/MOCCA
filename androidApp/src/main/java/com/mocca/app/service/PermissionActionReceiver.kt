...
class PermissionActionReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        Napier.i("[PermissionActionReceiver] Permission $permissionId ${if (isApproved) "approved" else "denied"} for session $sessionId")
        ...
        // Log result
        Napier.i("[PermissionActionReceiver] Permission ${if (isApproved) "granted" else "denied"} via notification")
    }
}
