        ...
        if (intent.action == DownloadManager.ACTION_DOWNLOAD_COMPLETE) {
            ...
            receiverScope.launch {
                try {
                    ...
                    Napier.i("Received ACTION_DOWNLOAD_COMPLETE for ID: $downloadId. Active ID: $activeDownloadId", tag = "ApkDownloadReceiver")
                                ...
                                if (status == DownloadManager.STATUS_SUCCESSFUL) {
                                    ...
                                    if (uriColumn >= 0) {
                                        ...
                                        if (uriString != null) {
                                            ...
                                            Napier.i("Download complete successfully. URI: $uriString. Installing...", tag = "ApkDownloadReceiver")
                                    ...
                                    Napier.e("Download failed with status $status and reason $reason", tag = "ApkDownloadReceiver")
                                }
                            }
                        }
                        cursor?.close()
