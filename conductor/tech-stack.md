...
## Overview
MOCCA is built on the **Kotlin Multiplatform** ecosystem, designed for a modern, high-performance Android experience with cross-platform potential.

## Language
- **Kotlin (v2.3.0):** The primary language for all application logic and UI.
...
## Platform Support
- **Android:** The primary target platform, utilizing the latest SDK (v36).
- **Multiplatform Ready:** Architected to support additional platforms (JVM/Desktop) through shared logic.
