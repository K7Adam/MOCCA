 ...
 * @param language Language identifier for syntax highlighting (e.g. "kotlin", "python", "json").
 * @param editable true for textarea edit mode, false for read-only highlighted view.
